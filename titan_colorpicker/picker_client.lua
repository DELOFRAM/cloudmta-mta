...
function colorPicker.create(id, start, title)
	...
	cp.gui.okb = guiCreateButton(336, 235, 64, 24, "Wybierz", false, cp.gui.window)
	cp.gui.closeb = guiCreateButton(336, 265, 64, 24, "Anuluj", false, cp.gui.window)
	...
	exports.titan_cursor:showCustomCursor("pickerClient")
	return cp
end
...
function colorPicker:destroy()
	...
	exports.titan_cursor:hideCustomCursor("pickerClient")
end
