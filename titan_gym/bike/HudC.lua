...
function showBarBike()
	local width = math.max(math.min(bike.Processing or 0,Class.HUD.bar.Full[1].W),0)
	...
	local width = math.max( math.min(Class.HUD.bar.Full[1].W-bike.Fatigue or 0, Class.HUD.bar.Full[1].W),0) 
