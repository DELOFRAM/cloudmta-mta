...
function startCarPaintReflectLite()
		...
		setEffectv()
		-- Create stuff
		grunShader = dxCreateShader ( "shaders/veh/fx/car_refgrun.fx",1,v.renderDistance,true)
		geneShader = dxCreateShader ( "shaders/veh/fx/car_refgene.fx",1,v.renderDistance,true)
		shatShader = dxCreateShader ( "shaders/veh/fx/car_refgene.fx",1,v.renderDistance,true)
		...
		if grunShader and geneShader and shatShader and myScreenSource then
			...
			-- Set textures
			textureVol = dxCreateTexture ( "shaders/veh/images/smallnoise3d.dds" )
			textureFringe = dxCreateTexture ( "shaders/veh/images/ColorRamp01.png" )
